...
STATIC_ATOMS = [
    ...
    Atom("show_modal", "show-modal"),
    Atom("show_popover", "show-popover"),
    ...
    Atom("toggle", "toggle"),
    Atom("toggle_popover", "toggle-popover"),
    Atom("token", "token"),
    ...
    Atom("B", "B"),
    Atom("background_color", "background-color"),
    ...
    Atom("cm", "cm"),
    Atom("color_burn", "color-burn"),
    Atom("color_dodge", "color-dodge"),
    Atom("color_interpolation", "color-interpolation"),
    Atom("color_interpolation_filters", "color-interpolation-filters"),
    Atom("color_profile", "color-profile"),
    Atom("cursor", "cursor"),
    Atom("cx", "cx"),
    Atom("cy", "cy"),
    Atom("d", "d"),
