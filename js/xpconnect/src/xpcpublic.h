...
[[nodiscard]] inline bool NonVoidStringToJsval(
    JSContext* cx, const nsAString& readable, JS::MutableHandleValue vp) {
...
[[nodiscard]] inline bool NonVoidUTF8StringToJsval(
    JSContext* cx, const nsACString& utf8, JS::MutableHandleValue vp) {
