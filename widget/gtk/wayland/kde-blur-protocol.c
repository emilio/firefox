...
WL_EXPORT extern const struct wl_interface org_kde_kwin_blur_interface;
WL_EXPORT extern const struct wl_interface wl_region_interface;
WL_EXPORT extern const struct wl_interface wl_surface_interface;
...
WL_EXPORT const struct wl_interface org_kde_kwin_blur_manager_interface = {
    "org_kde_kwin_blur_manager",        1, 2,
    org_kde_kwin_blur_manager_requests, 0, NULL,
};
...
WL_EXPORT const struct wl_interface org_kde_kwin_blur_interface = {
    "org_kde_kwin_blur", 1, 3, org_kde_kwin_blur_requests, 0, NULL,
};
