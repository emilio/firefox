 ...
 */
/**
 * @defgroup iface_org_kde_kwin_blur_manager The org_kde_kwin_blur_manager
 * interface
 */
...
/** @ingroup iface_org_kde_kwin_blur_manager */
static inline void org_kde_kwin_blur_manager_set_user_data(
    struct org_kde_kwin_blur_manager* org_kde_kwin_blur_manager,
    void* user_data) {
  wl_proxy_set_user_data((struct wl_proxy*)org_kde_kwin_blur_manager,
                         user_data);
}

/** @ingroup iface_org_kde_kwin_blur_manager */
static inline void* org_kde_kwin_blur_manager_get_user_data(
    struct org_kde_kwin_blur_manager* org_kde_kwin_blur_manager) {
  return wl_proxy_get_user_data((struct wl_proxy*)org_kde_kwin_blur_manager);
}

static inline uint32_t org_kde_kwin_blur_manager_get_version(
    struct org_kde_kwin_blur_manager* org_kde_kwin_blur_manager) {
  return wl_proxy_get_version((struct wl_proxy*)org_kde_kwin_blur_manager);
}

/** @ingroup iface_org_kde_kwin_blur_manager */
static inline void org_kde_kwin_blur_manager_destroy(
    struct org_kde_kwin_blur_manager* org_kde_kwin_blur_manager) {
...
static inline struct org_kde_kwin_blur* org_kde_kwin_blur_manager_create(
  ...
  id =
      wl_proxy_marshal_constructor((struct wl_proxy*)org_kde_kwin_blur_manager,
                                   ORG_KDE_KWIN_BLUR_MANAGER_CREATE,
                                   &org_kde_kwin_blur_interface, NULL, surface);
...
/** @ingroup iface_org_kde_kwin_blur */
static inline void org_kde_kwin_blur_set_user_data(
    struct org_kde_kwin_blur* org_kde_kwin_blur, void* user_data) {
  wl_proxy_set_user_data((struct wl_proxy*)org_kde_kwin_blur, user_data);
}

/** @ingroup iface_org_kde_kwin_blur */
static inline void* org_kde_kwin_blur_get_user_data(
    struct org_kde_kwin_blur* org_kde_kwin_blur) {
  return wl_proxy_get_user_data((struct wl_proxy*)org_kde_kwin_blur);
}

static inline uint32_t org_kde_kwin_blur_get_version(
    struct org_kde_kwin_blur* org_kde_kwin_blur) {
  return wl_proxy_get_version((struct wl_proxy*)org_kde_kwin_blur);
}

/** @ingroup iface_org_kde_kwin_blur */
static inline void org_kde_kwin_blur_destroy(
    struct org_kde_kwin_blur* org_kde_kwin_blur) {
 ...
 * @ingroup iface_org_kde_kwin_blur
 */
static inline void org_kde_kwin_blur_commit(
    struct org_kde_kwin_blur* org_kde_kwin_blur) {
...
static inline void org_kde_kwin_blur_set_region(
    struct org_kde_kwin_blur* org_kde_kwin_blur, struct wl_region* region) {
  wl_proxy_marshal((struct wl_proxy*)org_kde_kwin_blur,
 ...
 * @ingroup iface_org_kde_kwin_blur
 */
static inline void org_kde_kwin_blur_release(
    struct org_kde_kwin_blur* org_kde_kwin_blur) {
  wl_proxy_marshal((struct wl_proxy*)org_kde_kwin_blur,
